  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <section className="flex flex-col items-center mb-8">
        ...
        />
        <h1 className="text-gray-600 text-2xl font-bold">pen2</h1>
        <p className="text-gray-600">Software Engineer</p>
      </section>

      {/* プロフィールセクション */}
      <section className="bg-white rounded-lg shadow-md p-6 mb-8">
        <h2 className="text-[#000000] text-xl font-semibold mb-4">PROFILE</h2>
        <p className="text-gray-600 text-sm md:text-base mb-4 mx-4">
          2001年2月23日生まれ。<br />
      ...
      {/* スキルセクション */}
      <section className="bg-white rounded-lg shadow-md p-6 mb-8">
        <h2 className="text-[#000000] text-xl font-semibold mb-4">SKILLS & TECH STACK</h2>
      ...
      {/* このサイトについて */}
      <section className="bg-white rounded-lg shadow-md p-6 mb-8">
        <h2 className="text-[#000000] text-xl font-semibold mb-4">ABOUT THIS SITE</h2>
        <p className="text-gray-600 text-sm md:text-base mb-4 mx-4">
      ...
      <section className="bg-white rounded-lg shadow-md p-6">
        <h2 className="text-[#000000] text-xl font-semibold mb-4">CONTACT & LINKS</h2>
