    ...
    <div className="max-w-4xl mx-auto">
      ...
      <section className="flex flex-col items-center mb-8">
        <Image
          ...
          width={128}
          height={128}
          className="w-32 h-32 rounded-full object-cover mb-4 border-2 border-neon-border"
        />
        <h1 className="text-neon-text text-2xl font-bold">pen2</h1>
        <p className="text-neon-muted">Software Engineer</p>
      </section>

      {/* プロフィールセクション */}
      <section className="bg-neon-card rounded-lg shadow-lg border border-neon-border p-6 mb-8">
        <h2 className="text-neon-text text-xl font-semibold mb-4">PROFILE</h2>
        <p className="text-neon-muted text-sm md:text-base mb-4 mx-4 leading-relaxed">
          2001年2月23日生まれ。<br />
      ...
      {/* スキルセクション */}
      <section className="bg-neon-card rounded-lg shadow-lg border border-neon-border p-6 mb-8">
        <h2 className="text-neon-text text-xl font-semibold mb-4">SKILLS & TECH STACK</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 ml-4">
          {/* フロントエンド */}
          <div>
            <h3 className="text-neon-cyan text-lg font-medium mb-2">Frontend</h3>
            <ul className="list-disc list-inside text-neon-muted space-y-1 ml-4">
              <li>HTML/CSS</li>
      ...
      {/* このサイトについて */}
      <section className="bg-neon-card rounded-lg shadow-lg border border-neon-border p-6 mb-8">
        <h2 className="text-neon-text text-xl font-semibold mb-4">ABOUT THIS SITE</h2>
        <p className="text-neon-muted text-sm md:text-base mb-4 mx-4 leading-relaxed">
      ...
      {/* 連絡先・SNSリンク */}
      <section className="bg-neon-card rounded-lg shadow-lg border border-neon-border p-6">
        <h2 className="text-neon-text text-xl font-semibold mb-4">CONTACT & LINKS</h2>
        <div className="space-y-2 ml-4">
          ...
          <a 
            ...
            className="flex items-center text-neon-muted hover:text-neon-cyan text-sm transition-colors duration-300"
          >
